...
public class BootProj13SelectCrudRepoSpringJpaApplication {
	...
	public static void main(String[] args) {
		...
		listStudent.forEach(stud->System.out.println(stud.getSid()+"\t"+stud.getName()+"\t"+stud.getAddr()+"\t"+stud.getAvgMarks()));
		//find by id
		System.out.println("===========================find by id");
		Iterable<Student> listOfStudent=	service.fetchByStudentId(List.of(103,102));
		listOfStudent.forEach(stud->System.out.println(stud.getSid()+"\t"+stud.getName()+"\t"+stud.getAddr()+"\t"+stud.getAvgMarks()));
